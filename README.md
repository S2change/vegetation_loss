...
entregáveis:
  ...
  * E3.3 – Relatório de validação dos mapas nacionais. Foram feitos dois exercícios de validação descritos abaixo. (30 de junho 2025)
    - Usando [BDR_DGT_300](data_info/reference_data/BDR_DGT_300) e os mapas bimestrais de perdas de vegetação. Ver [script](scripts/validation/raster_avaliacao_exatidao.py) e relatório E3.3A.
