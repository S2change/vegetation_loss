...
Some GFM for burned areas and other applications using Sentinel-2 imagery
...
5. Clay Foundation Model: [An open source AI model for Earth](https://clay-foundation.github.io/model/index.html)
6. [SATLAS](https://allenai.org/blog/satlaspretrain-models-foundation-models-for-satellite-and-aerial-imagery-1679ebe4bbfb) SatlasPretrain Models: foundation models for satellite and aerial imagery
