...
output_filename='BDR_MIX_TNE_V03.shp'
...
# icnf
gdf = gpd.read_file(fn_icnf_2023, parse_dates=['DH_inicio','DH_Fim']) # dates read as strings e.g. '2023-02-03'
...
# reformat ICNF
gdf_icnf_2023['label']='icnf_2023_tne'
