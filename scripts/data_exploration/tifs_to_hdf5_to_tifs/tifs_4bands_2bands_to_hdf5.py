...
# 21/4/2026:
MIN_DATE=datetime(2018, 10, 31).date() #datetime(2018, 6, 30).date() # datetime(2017, 1, 1) # set a minimum date to filter out files with earlier timestamps
MAX_DATE=datetime(2020, 2, 28).date() # datetime(2030, 1, 1) # set a maximum date to filter out files with later timestamps
MIN_DATE=datetime(2022, 10, 31).date() #datetime(2018, 6, 30).date() # datetime(2017, 1, 1) # set a minimum date to filter out files with earlier timestamps
MAX_DATE=datetime(2024, 2, 28).date() # datetime(2030, 1, 1) # set a maximum date to filter out files with later timestamps

# from    
tile_list =['T29SND', 'T29TPE', 'T29SPD', 'T29TNE', 'T29SNB', 'T29TPF', 'T29TNF', 'T29SMD', 'T29SNC']
# 21 abril 2026 (for Data_ref_2019_nvg_v2.gpkg, using scripts\data_exploration\archive\list_s2tiles_that_include_features_from_gpkg_file.py)
tile_list=['T29SNB', 'T29SNC', 'T29SND', 'T29SPD', 'T29TNE', 'T29TNF', 'T29TNG', 'T29TPE'] # 2019 nvg_v2
# NOta: 'T29SNB' foi apagado por engano para 2019
# 22 abril 2026 (for Data_ref_2023_nvg_v2.gpkg, using scripts\data_exploration\archive\list_s2tiles_that_include_features_from_gpkg_file.py)
tile_list=['T29SNB', 'T29SNC', 'T29SND', 'T29SPC', 'T29TNE', 'T29TNF', 'T29TNG', 'T29TPE', 'T29TPF'] # 2023 nvg_v2
