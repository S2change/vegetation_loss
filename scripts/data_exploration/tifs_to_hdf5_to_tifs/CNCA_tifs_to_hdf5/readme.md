...
- From the original tile, omne only keep the "tight bbouunding box": see bounds below and ilustration <scripts/data_exploration/tifs_to_hdf5_to_tifs/CNCA_tifs_to_hdf5/s2_tiles_and_tight_bboxes_portugal.png>
