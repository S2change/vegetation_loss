...
1. GeoTIFF filenames to be processed for a gicen tile (e.g. 'T29TNE') need to satisfy the following condition: `f.endswith('.tif') and 'S2C_MSIL2A' in f and tile in f and 'mask_omni' not in f`
